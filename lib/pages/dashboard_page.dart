...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget build(BuildContext context) {
    if (_loading) {
      return AppScaffold(
        navIndex: 1,
        body: const Center(child: CircularProgressIndicator(color: AppColors.blueLight)),
      );
    }
    return AppScaffold(
      navIndex: 1,
        ...
        child: Row(
          ...
          children: [
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text('Dernière connexion : ${_formatLogin(user.lastLogin)}',
                  style: AppText.small),
            ]),
            ElevatedButton.icon(
...
class _RessourcesCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AppCard(
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const SectionTitle(icon: Icons.library_books_outlined, title: 'Ressources récentes'),
          ...
          ...ressources.map((r) => Padding(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(children: [
                      const Icon(Icons.article_outlined, color: AppColors.blueLight, size: 22),
                      const SizedBox(width: 12),
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text(r.titre, style: AppText.label,
  ...
  Widget build(BuildContext context) {
    ...
    return AppCard(
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        const SizedBox(height: 14),
        ...conversations.asMap().entries.map((e) => Column(children: [
  ...
  Widget build(BuildContext context) => Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            Text(DateFormat('HH:mm').format(conv.lastMessageAt),
