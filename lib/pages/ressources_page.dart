...
class _RessourcesPageState extends State<RessourcesPage> {
  ...
  List<RessourceModel> get _filtered => _ressources.where((r) {
    final typeOk = _filtreType.isEmpty ||
        (r.typeRessource?.toUpperCase() == _filtreType);
    final catOk = _filtreCategorie.isEmpty ||
          ...
          slivers: [
            ...
            if (_loading)
              const SliverFillRemaining(
                child: Center(child: CircularProgressIndicator(color: Color(0xFF1C3177))),
              )
            else ...[
              // ── Filtres ─────────────────────────────────────────────────
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(children: [
            ...
            const Padding(
              ...
              child: Text('›', style: TextStyle(fontSize: 12, color: _textGrey)),
            ),
          ...
          Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const Text('Découvrez toutes les ressources publiées par la communauté',
  ...
  Widget _buildResultsHeader() => Padding(
        ...
        child: Row(children: [
          const Text('Toutes les ressources',
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                // Description
                if (ressource.description != null && ressource.description!.isNotEmpty)
                ...
                Row(children: [
                  ...
                  const SizedBox(width: 4),
                  Text(_formatDate(ressource.dateCreation),
                      style: const TextStyle(fontSize: 12, color: _textGrey)),
                ]),
              ]),
            ),
            ...
            Container(
              ...
              child: Row(children: [
                ...
                const SizedBox(width: 6),
                Text('Voir', style: const TextStyle(fontSize: 13, color: _blue,
                    fontWeight: FontWeight.w600)),
                const Spacer(),
...
class _RessourceDetailPageState extends State<RessourceDetailPage> {
  ...
  Future<void> _supprimer() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text('Supprimer « ${_data!['titre']} » ? Cette action est irréversible.'),
        actions: [
  ...
  String _mois(int m) => const ['', 'janvier', 'février', 'mars', 'avril', 'mai', 'juin',
  ...
  Widget _buildError() => Center(
        child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            const SizedBox(height: 16),
            Text(_error!, style: const TextStyle(fontSize: 15, color: _textDark),
    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          ...
          const SizedBox(width: 6),
          Text(_labelType(d['typeRessource']),
              style: const TextStyle(fontSize: 12, color: _textGrey)),
        ]),
        const SizedBox(height: 10),
        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            const Row(children: [
              Icon(Icons.description_outlined, size: 16, color: _textDark),
              SizedBox(width: 6),
              Text('Contenu', style: TextStyle(fontSize: 14,
        ...
        // ── Lien externe ─────────────────────────────────────────────────
        if (d['lienPartage'] != null && d['lienPartage'].toString().isNotEmpty) ...[
          Container(
            width: double.infinity,
            ...
            child: Row(children: [
              ...
              const SizedBox(width: 8),
              Expanded(child: Text(d['lienPartage'],
        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            const Row(children: [
              ...
              SizedBox(width: 6),
              Text('Informations', style: TextStyle(fontSize: 14,
                  fontWeight: FontWeight.w700, color: _textDark)),
            ]),
            const SizedBox(height: 12),
            _MetaRow(label: 'Auteur', value: _nomAuteur(d['utilisateur'])),
            if (d['categorie'] != null)
              _MetaRow(label: 'Catégorie', value: d['categorie']['nom'] ?? ''),
            _MetaRow(label: 'Type', value: _labelType(d['typeRessource'])),
            if (d['typeRelation'] != null)
              _MetaRow(label: 'Relation', value: _labelRelation(d['typeRelation'])),
            if (d['niveauDifficulte'] != null)
              _MetaRow(label: 'Niveau', value: _labelNiveau(d['niveauDifficulte'])),
            _MetaRow(label: 'Publié le', value: _formatDate(d['dateCreation'])),
...
class _FilterCol extends StatelessWidget {
  ...
  const _FilterCol({required this.label, required this.value,
